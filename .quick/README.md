...
One-page cheat sheets for operators. Prefer these when you need a command fast; prefer [`START_HERE.md`](../START_HERE.md) when you are lost about *what* to do next.
...
**Free-text entry:** `@cto-director - <what you want>`
